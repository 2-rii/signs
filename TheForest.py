...
def betrayalofFate():
    ...
    print("<You enter the forest once again, using the knowledge of the forest that you obtained from the research back in Ayutthaya in an attempt to guide your way>\n")
    time.sleep(3)
    print("<You push through some thick bushes, brushing aside branches and vines as you make your way in deeper>\n")
    time.sleep(3)
    print("<The ground is uneven, roots sticking out in every direction, and you nearly trip more than once>\n")
    time.sleep(3)
    print("<Birds scatter overhead as you pass by, and you hear the distant sound of running water somewhere to your left>\n")
    time.sleep(3)
    print("<You stop for a moment, listening — something feels off>\n")
    time.sleep(3)
    print("<Suddenly, emerged from a bush, a giant creature>\n")
    time.sleep(3)
    print("<You know this creature, your father told you about it in fragments of folklore; a type of animal the forest dwellers have domesticated for battle purposes>\n")
    time.sleep(3)
    print("<You think about this situation very carefully; either you attempt to run away or you fight the creature. The decision is up to your intuition>\n")
    time.sleep(4)
