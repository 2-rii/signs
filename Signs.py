...
class Player:
    def __init__(self,name="Ras",xp=50.0,maxStamina=100.0,currentStamina=100.0,maxHealth=100.0,currentHealth=100.0,inventory={},weapons={"FI":[5,999,999,"Fist"]},potions={},spawnRoom="Home",currentRoom="Home",currentMission=1):
        self.name=name
        self.xp=xp
    ...
    def loadGame(self,fn):
        ...
        self.maxHealth = datatoLoad["maxHealth"]
        self.currentHealth = datatoLoad["currentHealth"]
        self.inventory = datatoLoad["inventory"]
        self.weapons = datatoLoad["weapons"]
        self.potions = datatoLoad["potions"]
        self.currentMission = datatoLoad["currentMission"]
        print(f'Game successfully retrieved and loaded from {fn}')
